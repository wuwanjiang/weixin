...
class wechatCallbackapiTest
{
    ...
    private function receiveText($object)
    {
        ...
        if($weather_key == '天气' && !empty($city_key) && $str_trans != '翻译'){
            ...
            $content = "<a href='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxf13a3c4057c6e847&redirect_uri=http://1.wuwj2018.applinzi.com/getUserinfo.php&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect'>体验OAuth授权</a>";
